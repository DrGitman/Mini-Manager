      ...
      <div className="container mx-auto px-6 md:px-16 max-w-7xl relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
          <motion.div
            ...
            className="flex-1"
          >
            <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#171c2f] border border-[#3c4561] text-xs font-bold tracking-widest text-[#9198b7] uppercase mb-6">
              LIVE DEMO
            </div>

            <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 text-[#edeef3]">
              Experience Mini Manager <br/>
              <span className="text-gradient">No Install Required</span>
            </h2>

            <p className="text-[#9198b7] text-lg mb-8 leading-relaxed">
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-[#bec2d3]">
            ...
            {!demoActive && (
              <button 
                ...
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#00E5FF] to-[#7C4DFF] text-white font-bold text-base flex items-center justify-center gap-2 hover:opacity-90 transition-all w-full sm:w-auto"
              >
          ...
          >
            <div className="relative w-full aspect-[4/3] max-w-2xl mx-auto rounded-2xl bg-[#171c2f] border border-[#3c4561] overflow-hidden shadow-2xl flex flex-col">
              {/* Browser bar */}
              <div className="h-12 border-b border-[#3c4561] bg-[#0d1020] flex items-center px-4 gap-2">
                <div className="flex gap-1.5">
                  <div className="w-3 h-3 rounded-full bg-red-500/80" />
                  <div className="w-3 h-3 rounded-full bg-yellow-500/80" />
                  <div className="w-3 h-3 rounded-full bg-green-500/80" />
                </div>
                <div className="mx-auto w-1/2 h-6 bg-[#171c2f] rounded-md border border-[#3c4561] flex items-center justify-center">
                  <span className="text-xs text-[#9198b7] font-mono">demo.minimanager.ai</span>
                </div>
              </div>
              ...
              <div className="flex-1 relative bg-[#0A0E17] flex items-center justify-center p-6">
                {demoActive ? (
                  <div className="absolute inset-0 flex items-center justify-center flex-col text-center p-8">
                    ...
                    <p className="text-[#9198b7] text-sm mt-2">Placeholder for Vercel hosted demo iframe</p>
                  </div>
                ) : (
                  <div className="text-center">
                    <div className="w-20 h-20 bg-[#0d1020] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg border border-[#3c4561]">
                      <Play fill="#FF6D00" className="text-[#FF6D00] ml-1" size={32} />
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2">Ready to explore?</h3>
                    <p className="text-[#9198b7] text-sm max-w-sm mx-auto">
            ...
            <div className="mt-6 flex items-start gap-3 bg-[#171c2f] border border-[#3c4561] rounded-xl p-4">
              <AlertCircle className="text-[#9198b7] shrink-0 mt-0.5" size={18} />
              <p className="text-sm text-[#bec2d3] leading-relaxed">
